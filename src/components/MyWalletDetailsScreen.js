      ...
      return(
        <View style={styles.container}>
          ...
          <View style={styles.balanceContainer}>
            {updatingBalance ? <ActivityIndicator size="small" color="#fff" style={styles.balanceLoading} /> : <TouchableOpacity onPress={() => this.updateBalance()}><Text style={styles.balanceText}>{`${walletUtils.wallet.balance/10000} AEGS`}</Text></TouchableOpacity>}
            <Text>
    ...
    return(
      <View style={styles.txContainer}>
        ...
        <View style={styles.txAmount}>
          <Text style={styles.txAmountText}>{tx.type === 'Sent' ? "-" : "+"}{`${tx.amount.toFixed(2)} AEGS`}</Text>
